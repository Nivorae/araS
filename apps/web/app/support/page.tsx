  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-[#1c1c1e]">
      ...
      <Section title="常見問題">
        ...
        <p>
          最快的方式是直接在 App 內操作：登入後點選底部導覽的
          <strong>設定</strong>，選擇<strong>刪除帳號</strong>
          並確認，帳號與所有相關資料會立即永久刪除，無法復原。
        </p>
        <p className="mt-2">
          若你無法登入
          App，也可以請我們代為刪除：請寄信至上方電子郵件，主旨註明「刪除帳號」，並使用你註冊時的電子郵件來信。我們會在收到請求後的合理期間內，
          永久刪除你的帳號與所有相關資料。
        </p>
      </Section>
